...
public class VisitController {
   ...
   /* @GetMapping("/addVisitDetail/{petId}")
    ...
    public String aptToVisit(@PathVariable(value = "aptId")Long aptId, Model model) throws RecordNotFoundException {
        ...
        List<Vet> vets = vetService.getAllVets();
        model.addAttribute("vets", vets);
        //On appointment page, click on add to visit - done
        //returns to /addVisitDetail/{petId} - done
        //Date and time is transferred to the form
        //Description is transferred to the form. They can add more description
        //Add the vet of choice
        //Click add visit
        //delete appointment by id. So I need to pass the apt id.
        return "visit/apt-to-visit";
    }
}
