package com.pet.clinic.constant;
...
public class ErrorMessage {
    ...
    public static final String LASTNAME_IS_REQUIRED_ERROR_MESSAGE = "Last name is required.";
    ...
    public static final String DOB_IS_REQUIRED_ERROR_MESSAGE = "You must select the date of birth";
    // PetType:
    public static final String PET_TYPE_IS_REQUIRED_ERROR_MESSAGE = "Pet type is required.";
    public static final String PET_TYPE_SIZE_LIMIT_ERROR_MESSAGE = "Type name should be less than 50 characters";
    // Specialty:
    public static final String SPECIALTY_NAME_IS_REQUIRED_ERROR_MESSAGE = "Specialty name is required.";
    public static final String SPECIALTY_NAME_SIZE_LIMIT_ERROR_MESSAGE = "Specialty name should be less than 50 characters.";
    // Visit:
    public static final String VISIT_DATE_IS_REQUIRED_ERROR_MESSAGE = "Please select a visit date.";
